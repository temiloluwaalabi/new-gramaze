...
import NewMessageDialog from "@/components/dialogs/new-messaging-dialog";
...
type Props = {
  url?: string; // Optional - kept for compatibility
  showInline?: boolean; // If true, shows MessagesChatClient directly instead of navigating
};

/**
 * Smart dashboard component that shows:
 * - Empty state if no conversations
 * - Full messaging interface if conversations exist
 * - New message dialog when "Start conversation" is clicked
 */
export default function MessagesUserDashboardClient({ url }: Props) {
