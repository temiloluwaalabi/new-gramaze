...
import { CalendarEvent } from "../shared/calendar/day-js-calendar";
...
export const AppointmentSheet = (props: Props) => {
      ...
      <SheetContent className="!w-[596px] max-w-full border-none bg-transparent p-5 md:!max-w-[596px]">
        ...
        <div className="custom-scrollbar flex h-full flex-col overflow-y-scroll rounded-[6px] border border-gray-300 bg-white p-4">
          ...
          <div className="mb-6 gap-4 space-y-6">
            {props.appointment.caregiver && (
              <div className="space-y-3">
                <h6 className="text-sm font-medium text-[#333333]">
                  Caregiver details
                </h6>
                <AvatarNameEmail
                  name={`${props.appointment.caregiver.first_name} ${props.appointment.caregiver.last_name}`}
                  email={props.appointment.caregiver.email}
                  avatarImage={generateAvatarUrl(props.appointment.caregiver)}
                />
                <div className="flex items-center gap-[130px]">
                  <span className="flex w-full flex-col gap-[4px]">
                    ...
                    <span className="text-xs font-semibold text-black">
                      {props.appointment.caregiver.phone}
                    </span>
                  </span>
                  <span className="flex w-full flex-col gap-[4px]">
                    <span className="text-xs font-normal text-[#66666B]">
                    ...
                    <span className="text-xs font-semibold text-black">
                      {props.appointment.caregiver.emergency_contact_phone}
                    </span>
                  </span>
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-[130px]">
                    ...
                    <span className="flex w-full flex-col gap-[4px]">
                      ...
                      <span className="text-xs font-semibold text-black">
                        {formatAppointmentDate(props.appointment.start)}
                      </span>
                    </span>
                  </div>
                </div>
