...
const PriceInput: React.FC<PriceInputProps> = ({
  ...
  return (
    <div className={`flex flex-col items-start`}>
      <div
        className={cn(
          "flex h-[51px] w-full items-center rounded-md !border",
          className
        )}
      >
        <span className="dark:bg-dark-200 text-primary dark:text-light-300 mr-2 flex h-full w-[40px] items-center justify-center rounded-ss-md rounded-es-md bg-red-200 text-base font-normal">
          {currency}
        </span>
        <Input
          type="text"
