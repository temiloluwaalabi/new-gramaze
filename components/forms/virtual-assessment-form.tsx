...
export default function VirtualAssessmentForm() {
  ...
  const handleSubmit = (values: z.infer<typeof VirtualAssessmentSchema>) => {
    updateData("appointment", {
      ...
      proposedHospitalArea: data.appointment.proposedHospitalArea,
      interestedPhysicalAppointment:
        data.appointment.interestedPhysicalAppointment,
    });
    ...
    <Form {...BiodataForm}>
      ...
      >
        <div className="space-y-4">
          ...
          />
          <div className="flex items-center gap-2 rounded-[8px] bg-gray-100 px-3 py-2 lg:h-[40px]">
