...
import { ResendOTP, VerifyOTP } from "@/app/actions/auth.actions";
...
export const RegisterVerifyOTPStep = ({
  isPasswordReset,
  ...
  React.useEffect(() => {
    registerForm.setValue("email", session?.email || "");
  }, [registerForm, session?.email]);
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <Button
              type="button"
              variant="link"
              className="flex items-center gap-2 bg-black font-medium text-white disabled:opacity-60"
